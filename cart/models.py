...
class Order(models.Model):
    user = models.ForeignKey(get_user_model(), on_delete=models.RESTRICT, related_name='order',
    ...
    product = models.ForeignKey(Product, on_delete=models.RESTRICT, related_name='order',
                                verbose_name='Товар')
